...
int GPU_loop_MultMat_execute(int index, int_fast8_t *status, int_fast8_t *GPUstatus, float alpha, float beta, int timing, int TimerOffsetIndex)
{
    ...
    for(ptn=0; ptn<gpumatmultconf[index].NBstreams; ptn++)
    {
        ...
        for(cnt=0; cnt<semval; cnt++)
        {
			printf("WARNING %s %d  : [%d] sem_trywait on semptr1 index %d ptn %d\n", __FILE__, __LINE__, cnt, index, ptn);
			fflush(stdout);   
        ...
        for(cnt=0; cnt<semval; cnt++)
        {
			printf("WARNING %s %d  : [%d] sem_trywait on semptr2 index %d ptn %d\n", __FILE__, __LINE__, cnt, index, ptn);
			fflush(stdout);
        ...
        for(cnt=0; cnt<semval; cnt++)
        {
			printf("WARNING %s %d  : [%d] sem_trywait on semptr3 index %d ptn %d\n", __FILE__, __LINE__, cnt, index, ptn);
			fflush(stdout);  
        ...
        for(cnt=0; cnt<semval; cnt++)
        {
			printf("WARNING %s %d  : [%d] sem_trywait on semptr4 index %d ptn %d\n", __FILE__, __LINE__, cnt, index, ptn);
			fflush(stdout);
        ...
        for(cnt=0; cnt<semval; cnt++)
        {
			printf("WARNING %s %d  : [%d] sem_trywait on semptr5 index %d ptn %d\n", __FILE__, __LINE__, cnt, index, ptn);
			fflush(stdout);
