...
)
{
    ...
    if(gpumatmultconf[index].init == 0)
    {
        ...
        gpumatmultconf[index].Nsize = (uint32_t *) malloc(sizeof(
                                          long) * gpumatmultconf[index].NBstreams);
        gpumatmultconf[index].Noffset = (uint32_t *) malloc(sizeof(
                                            long) * gpumatmultconf[index].NBstreams);
        ...
        gpumatmultconf[index].refWFSinit = (int *) malloc(sizeof(
        ...
        for(int device = 0; device < gpumatmultconf[index].NBstreams; device++)
        {
            cudaError_t error = cudaMemcpy(gpumatmultconf[index].d_wfsVec[device],
        ...
        // thread data
        gpumatmultconf[index].thdata = (CUDACOMP_THDATA *) malloc(sizeof(
                                           CUDACOMP_THDATA) * gpumatmultconf[index].NBstreams);
